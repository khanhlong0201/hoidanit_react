...
class ManageDoctor extends Component {
    ...
    componentDidUpdate(prevProps, presState, snapshot) {
        ...
        if (prevProps.allRequiredDoctorInfor !== this.props.allRequiredDoctorInfor) {
            ...
            let dataSelectPayment = this.buildDataInputSelect(resPayment, 'PAYMENT')
            let dataSelectProvince = this.buildDataInputSelect(resProvince, 'PROVINCE')
            console.log('voi qua di thoi', dataSelectPrice, dataSelectPayment, dataSelectProvince)
            this.setState({
                listPrice: dataSelectPrice,
                listPayment: dataSelectPayment,
                listProvince: dataSelectProvince,
    ...
    handleChangeSelectDoctorInfor = async (selectedOption, name) => {
        ...
        console.log('mama', selectedOption, stateName)
    }
    render() {
        let { hasOldData } = this.state;
        console.log('state nha', this.state)
        return (
            <div className='manage-doctor-container'>
                <div className='mangae-doctor-title'>
                    <FormattedMessage id="admin.manage-doctor.title" />
                </div>
                <div className='more-info'>
                    <div className='content-left form-groud'>
